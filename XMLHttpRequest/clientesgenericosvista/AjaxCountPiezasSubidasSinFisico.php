<?php
	...
	*/
	...
	$Consulta= "
		SELECT count(opi.Barra) as 'Contador'
		FROM sispoc5_Ocasa.PiezasIngresadas as opi
		left join sispoc5_gestionpostal.flash_piezas as fp on opi.barra = fp.barcode_externo
		where opi.Creacion >= '$FechaI'
		and opi.Creacion <= '$FechaF'
