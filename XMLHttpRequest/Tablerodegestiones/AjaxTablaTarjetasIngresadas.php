<?php
	...
	*/
	...
	$Consulta= "
		...
		#, GROUP_CONCAT( concat(Sucursales.Nombre, '-', Sucursales.Provincia, '-', Sucursales.Localidad, '-',Sucursales.Domicilio ) separator ' , ') as 'Sucursales'
		...
		(
			...
			#and fp.create >  DATE_ADD('2020-2-01', INTERVAL 0 HOUR) AND fp.create <  DATE_ADD('2021-02-03', INTERVAL 0 HOUR)
