		...
		select count(distinct(fp.barcode_externo)) as 'Contador'# select count(distinct(fp.id))
		...
		and pe.Activo = '1'
		and pe.idEstados not in ('8','17','1','13','6','14','9','15','16')#, '6', '14', '15', '16') #8 TARJETAS ENTREGADAS ,#0 SOLICITADAS POR EL CLIENTE (RECUPEROS) #6 Domicilio Insuficiente #14 Se Mudó #15 Se Niega A Recibir #16 Segunda visita No Entregado
