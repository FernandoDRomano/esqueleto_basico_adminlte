<?php
	...
	*/
	...
	$Columnas = array("Pieza","Marca","Tipo","Fecha Ultimo Estado","Estado Actual","Destinatario","DNI","Domicilio","Ciudad","Provincia","Numero De Pieza Para Banco","Sucursal Bancaria","Sucursal De Cuenta");
	$Consulta= "
		SELECT NumPiezaCorreo as 'Pieza', MarcaTarjeta as 'Marca', TipoTarjeta as 'Tipo'
		, FechaEstadoPieza as 'Fecha Ultimo Estado', EstadoPieza as 'Estado Actual'
		, ApellidoYNombre as 'Destinatario', DNI as 'DNI', Domicilio as 'Domicilio', Ciudad as 'Ciudad', Provincia as 'Provincia'
		, NumPiezaBanco as 'Numero De Pieza Para Banco', sucursale_id as 'Sucursal Bancaria', SucursalRadicacion as 'Sucursal De Cuenta'
		FROM sispoc5_consultasweb.piezas as p 
		WHERE
		(DatoBanco like ''
		and MotivoPieza like '')
		order by NumPiezaCorreo asc
	";
	$Resultado = $ClaseMaster->SQL_Master($Consulta,$Columnas,$time,true);
	if($Resultado){
