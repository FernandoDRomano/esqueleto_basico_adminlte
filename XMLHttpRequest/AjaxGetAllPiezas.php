<?php
	...
	*/
	...
	//Modificaciones 14-01-2020: en las variables consulta y columna
	...
	$Consulta= "
		...
		(
            ...
            (
				...
				#and  (Piezas.barcode_externo like '$NumeroDePieza%' or '$NumeroDePieza' = '' or Piezas.Barcode like '$NumeroDePieza%') 
