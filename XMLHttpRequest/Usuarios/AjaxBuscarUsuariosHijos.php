<?php
	...
	*/
	...
	if($IdUsuario == '1'){
		$Columnas = array("Alias","Password","Email","Nombre","Apellido","Fecha De Creacion");//,"Password"
		$Consulta= "
			SELECT U.us_name as 'Alias'
			,U.us_password as 'Password'
			,U.us_mail as 'Email'
		...
		$Columnas = array("Alias","Email","Nombre","Apellido","Fecha De Creacion");//,"Password"
		$Consulta= "
			SELECT U.us_name as 'Alias'
			,U.us_mail as 'Email'
			,U.us_nombre as 'Nombre'
