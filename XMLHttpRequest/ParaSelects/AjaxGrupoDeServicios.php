<?php
	...
	*/
	...
	if($Id != ""){
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_gestionpostal.flash_servicios_grupos WHERE id = '$Id'
			order by nombre asc
		";
	}else{
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_gestionpostal.flash_servicios_grupos WHERE 1
			order by nombre asc
		";
	}
