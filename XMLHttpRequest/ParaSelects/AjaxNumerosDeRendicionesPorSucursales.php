 <?php
	...
	*/
	...
	$Consulta= "
		SELECT r.id as 'Id', r.id as 'Nombre'
		FROM sispoc5_gestionpostal.flash_rendiciones as r
		inner join sispoc5_gestionpostal.users as u on u.id = r.usuario_id
		where u.sucursal_id in $SucursalesDeUsuario and r.create > (CURRENT_DATE - INTERVAL 30 DAY)
		ORDER BY r.id DESC
	";
	//echo("1|" . $Consulta);
	//exit;
