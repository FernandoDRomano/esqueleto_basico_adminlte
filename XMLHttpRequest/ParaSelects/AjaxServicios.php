<?php
	...
	*/
	...
	if($Id != ""){
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_gestionpostal.flash_servicios WHERE grupo_id = '$Id'
			order by nombre asc
		";
	}else{
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_gestionpostal.flash_servicios WHERE 1
			order by nombre asc
		";
	}
