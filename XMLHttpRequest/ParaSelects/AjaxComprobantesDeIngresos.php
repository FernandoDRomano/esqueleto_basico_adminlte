 <?php
	...
	*/
	...
	$Consulta= "
		SELECT distinct(ci.id) as 'Id', concat('CI:',ci.numero) as 'Nombre' 
		...
		#inner join sispoc5_gestionpostal.flash_comprobantes_ingresos_servicios as cis on cis.comprobante_ingreso_id = ci.id #Ci Puede Tener Diferentes Servicios
		where ci.sucursal_id in $SucursalesDeUsuario and ci.create > (CURRENT_DATE - INTERVAL 60 DAY)
		and fp.tipo_id = '2'
		order by id asc
	";
