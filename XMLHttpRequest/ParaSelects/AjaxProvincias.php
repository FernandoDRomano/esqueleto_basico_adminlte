<?php
	...
	*/
	...
	if($Id != ""){
		$Consulta= "
			SELECT id as 'Id', Nombre as 'Nombre' FROM sispoc5_correoflash.provincias WHERE id = '$Id'
			order by nombre asc
		";
	}else{
		$Consulta= "
			SELECT id as 'Id', Nombre as 'Nombre' FROM sispoc5_correoflash.provincias WHERE 1
			order by nombre asc
		";
	}
