 <?php
	...
	*/
	...
	if($Id != ""){
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_correoflash.localidades WHERE IdProvincia = '$Id'
			order by nombre asc
		";
	}else{
		$Consulta= "
			SELECT id as 'Id', nombre as 'Nombre' FROM sispoc5_correoflash.localidades WHERE 1
			order by nombre asc
		";
	}
