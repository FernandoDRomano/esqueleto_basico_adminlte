<?php
	...
	*/
	...
	$Columnas = array("Grupo","Sucursal","Fecha De Creacion");
	$Consulta= "
		SELECT gds.NombreDeGrupo as 'Grupo'
		, s.Nombre as 'Sucursal'
		, seg.FechaDeCreacion as 'Fecha De Creacion'
		...
		inner join sispoc5_correoflash.Sucursales as s on seg.IdSucursales = s.ID
		WHERE 1
		order by gds.NombreDeGrupo asc
	";
	$Resultado = $ClaseMaster->SQL_Master($Consulta,$Columnas,$time,true);
