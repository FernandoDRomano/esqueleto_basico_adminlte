<?php
	...
	*/
	...
	$Consulta= "
		SELECT pd.id as 'Despacho', fs.nombre as 'Sucursal De Origen', fsd.nombre as 'Sucursal De Destino', ci.numero as 'Comprobante De Ingreso', fp.id as 'Pieza Id', fp.barcode_externo as 'Barcode', peApp.NombreDeEstado as 'Estado'
		, case pe.Activo
		when '0' then 'No'
		when '1' then  'Si'
		else ''
		...
		left join sispoc5_Banco.Estados as peApp on pe.idEstados = peApp.Id
