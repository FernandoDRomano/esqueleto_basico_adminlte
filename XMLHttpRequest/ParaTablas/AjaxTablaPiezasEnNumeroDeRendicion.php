<?php
	...
	*/
	...
	$Consulta= "
		SELECT fp.id as 'Pieza Id', fp.barcode_externo as 'Barcode', hdr.id as 'Hoja De Ruta', suc.nombre as 'Sucursal', Cartero.apellido_nombre as 'Cartero', hdr.create as 'Fecha De Creacion De HDR', eapp.NombreAPP as 'Estado', pe.Fecha as 'Fecha De Estado'
		...
		inner join sispoc5_gestionpostal.flash_hojas_rutas as hdr on fp.hoja_ruta_id = hdr.id
		inner join sispoc5_gestionpostal.flash_sucursales as suc on hdr.sucursal_id = suc.id
