<?php
	...
	*/
	...
	$Cliente = issetornull('Cliente');
	
	
	$Columnas = array("id","Nombre");
	$Consulta= "
		SELECT fs.id as 'id', fce.nombre as 'Nombre'
		FROM sispoc5_gestionpostal.flash_servicios as fs
		INNER JOIN sispoc5_gestionpostal.flash_clientes_precios_especiales as fce on fs.id = fce.servicio_id
		INNER JOIN sispoc5_gestionpostal.flash_clientes as fc ON fc.id = fce.cliente_id
