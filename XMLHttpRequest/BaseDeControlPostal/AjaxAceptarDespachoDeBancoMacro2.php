<?php
	...
	*/
	...
	$Consulta="
		...
		inner join sispoc5_Banco.PiezasEstados as pe on fp.id = pe.idPieza and (pe.idEstados in ('28','30','32','34','36','38','40','42','44','46','48','50'))
		inner join (
		...
		inner join sispoc5_Banco.Estados as peApp on pe.idEstados = peApp.Id and peApp.Id in ('28','30','32','34','36','38','40','42','44','46','48','50')#('30','32','34','36','38','40','42','44','46','48','50')
		...
		$Consulta="
			...
			inner join (
				...
				from sispoc5_gestionpostal.flash_piezas_despacho as pd
					...
					inner join sispoc5_consultasweb.piezas as p on pe.NumeroPieza = p.NumPiezaCorreo
				where
				pd.id = '$DespachosActivosEnviados'
			) as fp
			SET 
