	...
	*/
	...
	//Config
	function Needed(ElementId,DigitosMinimos){
		...
		if (VirtualElementId.value.length <= 0) {
			if (typeof $.bootstrapGrowl === "function") {
				$.bootstrapGrowl( "Complete El Campo", {
					type: 'danger',//danger
					align: 'center',
					width: 'auto'
				});
			...
			if(VirtualElementId.value.length<DigitosMinimos){
				if (typeof $.bootstrapGrowl === "function") {
					$.bootstrapGrowl( "Faltan: "+ (- VirtualElementId.value.length + DigitosMinimos) + " Digitos En Este Campo", {
						type: 'danger',//danger
						align: 'center',
						width: 'auto'
					});
