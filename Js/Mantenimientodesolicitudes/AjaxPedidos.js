	...
	*/
	...
	$('#ServicioGrupo').change(function() {
		...
		var Config = JSON.parse(`
		{
			...
			"Ajax":"` + URLJS + `XMLHttpRequest/ParaSelects/AjaxServicios.php"
		}`);
		//"ValoresDirectos":null,
		//"ValoresDirectos":` + ValoresDirectos + `,
		SelectDesdeConsulta(Config);
