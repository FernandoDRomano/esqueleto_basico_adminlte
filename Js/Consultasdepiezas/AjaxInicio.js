...
function DescargarReporteCompleto(){
	...
	var Config = JSON.parse(`{
		"exel":true,
		"txt":true,
		"Folder":"`+SUBDOMINIO + `XMLHttpRequest/",
		"NombreDelFichero":"` + NombreDelFichero + `",
		"DataAjax":` + Parametros + `,
		"ValoresDirectos":` + ValoresDirectos + `,
		"Ajax":"` + URLJS + `XMLHttpRequest/AjaxGetAllPiezas.php"
	}`);
...
function DescargarReporteCompletoUltimosEstados(){
	...
	var Config = JSON.parse(`{
		"exel":true,
		"txt":true,
		"Folder":"XMLHttpRequest/",
		"NombreDelFichero":"` + NombreDelFichero + `",
		"DataAjax":` + Parametros + `,
		"ValoresDirectos":` + ValoresDirectos + `,
		"Ajax":"` + URLJS + `XMLHttpRequest/AjaxGetAllPiezasUltimosEstados.php"
	}`);
	AjaxConsultaYDescargaArchivo(Config);
}
