...
<div id="TableroDeGestiones" style="background: aliceblue;">
	<div class="CajaDeGrupos">
		<?php
			//Titulo
			Elementos::CrearDesplegableConTitulo("Tarjetas Debito","1");
			...
			Elementos::CrearBoton("BuscarPiezasDebito();","4","Buscar Piezas Debito","");//Para Banco Macro
			echo('<hr class="size1 hideline">');
			Elementos::Creardashboard("","PiezasDebito","Piezas Debito","12","Uncolor","SizablePiezasDebito");
			Elementos::CrearTabladashboard("PiezasDebito","3","Piezas Debito");
			echo('<hr class="size1 hideline">');
			Elementos::CerrarDesplegableConTitulo();
			echo('<hr class="size2 hideline">');
			
			
			Elementos::CrearDesplegableConTitulo("Tarjetas Credito","2");
			Elementos::CrearImputDeFecha("datetimepicker1","FechaDesde2","Fecha Inicial De Busqueda","6");
			Elementos::CrearImputDeFecha("datetimepicker2","FechaHasta2","Fecha Final De Busqueda","6");
			Elementos::CrearBoton("BuscarPiezasCredito();","4","Buscar Piezas Credito","");//Para Banco Macro
			echo('<hr class="size1 hideline">');
			Elementos::Creardashboard("","PiezasCredito","Piezas Credito","12","Uncolor","SizablePiezasCredito");
			Elementos::CrearTabladashboard("PiezasCredito","3","Piezas Credito");
			echo('<hr class="size1 hideline">');
			Elementos::CerrarDesplegableConTitulo();
			echo('<hr class="size2 hideline">');
