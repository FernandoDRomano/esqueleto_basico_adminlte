...
<div id="TableroDeGestiones" style="background: aliceblue;">
	<div class="CajaDeGrupos">
		<?php
			//Titulo
			Elementos::CrearTitulo("Quitar Piezas (BancoMacro) De Stock.");
			Elementos::CrearImput("Barcode","numberNoFloat","Barcode:","4");
			echo('<hr class="size1 hideline">');
			Elementos::CrearBoton("QuitarPiezaDeStock();","4","Quitar Pieza De Stock","");//De Banco Macro
			echo('<hr class="size1 hideline">');
