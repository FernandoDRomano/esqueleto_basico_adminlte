...
<img id="imgBase" src="../BasePDF.jpg" alt="Smiley face" height="auto" width="auto" hidden> 
		<?php
			...
			*/
			...
			echo('<hr class="size1 hideline">');
			Elementos::CrearBoton("DescargarPDF('TablaIngresadas','2');","6","Descargar PDF De Pedidos Visibles En Tabla Para PreImpreso","");
			Elementos::CrearBoton("DescargarPDF('TablaIngresadas','2',true);","6","Descargar PDF De Pedidos Visibles En Tabla Para B/N","");
			/*
