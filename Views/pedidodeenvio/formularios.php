	...
	<?php
		...
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-12">
				<?php
					Elementos::CrearLeftTitulo("Plantillas Predefinidas");
				...
				<?php
					Elementos::CrearLeftTitulo("Crea tu Plantilla");
				?>
						<!--
					<div id="toolBar1">
					...
					<?php
						...
						Elementos::CrearIniRow("12","border-color: #292d57;border-style: double;color: #292d57;");
							...
							Elementos::CrearLeftTitulo("Guardar En Mis Plantillas");
							Elementos::CrearImput("NombreDeFormulario","text","Ingrese Nombre de la Nueva Plantilla","6","value=''",true);//Combate De Las Piedras
						    ...
						    Elementos::CrearBoton("GuardarFormulario();","12","Guardar Plantilla","","","","btn2 btn-large btn-block btn-primary");//white-space: unset;
							Elementos::CrearFinRow();
							echo('<hr class="size2 hideline">');
							Elementos::CrearLeftTitulo("Editar O Borrar Mi Plantilla");
							Elementos::CrearBoton("EditarFormulario();","6","Editar Plantilla","","","","btn2 btn-large btn-block btn-warning");//white-space: unset;
							Elementos::CrearBoton("EliminarFormulario();","6","Eliminar Plantilla","","","","btn2 btn-large btn-block btn-Danger");//white-space: unset;
