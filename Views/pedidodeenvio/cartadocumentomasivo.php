	...
	?>
		<!--
			<div class="col-md-12" style="">
				<a href="../CartaDocumentoMasiva.xlsx" download>Descargar Documento Base Para Completar Los Datos De Carta Documento.
					<img src="../xlsx-512.png" alt="Documento Base" width="52px">
				</a>
			</div>
		-->
	<?php
	...
	/*
		...
		Elementos::CrearImput("DestinatarioCodigoPostal","numberNoFloat","Codigo Postal","4","value=''",true);//4000
		echo('<hr class="size1 hideline">');
	...
	*/
		...
		echo('<hr class="size1 hideline">');
		//Elementos::CrearImput("RemitenteDNITipoApoderado","text","Tipo De Documento","4","value=''",true);//DNI
		?>
		<div class="col-md-4">
			<div class="form-group">
				...
				?>
					...
					<div class="col-md-12" style="">
						...
						<div class="custom-select" id="myCustomSelect">
							<input type="text" style="text-align: left;" id="custom-select-input" autocomplete="off" class="select-css" aria-describedby="custom-select-info">
							...
							<ul class="custom-select-options hidden-all" id="custom-select-list">
								...
								<li>
									<strong style="font-size: 2em;">Intimación A Desalojo Por Finalización De Locación</strong>
								...
								<li>
									<strong style="font-size: 2em;">Intimación A Desalojo Por Incumplimiento De Contrato De Locación</strong>
								...
								<li>
									<strong style="font-size: 2em;">Intimación A Regularizar Situación Laboral</strong>
					...
					<label for=""><p style="font-size: 12px;margin-top: 0px;margin-bottom: 0px;color: #0000FF;">Subir plantilla</p></label>
				<?php
				...
				?>
					...
					<?php
						...
						/*Elementos::CrearIniRow("12","border-color: #292d57;border-style: double;color: #292d57;");
							Elementos::CrearLeftTitulo("Configurar Mis Formularios");
							echo("<div class='col-md-12' style=''> <b style='font-size: 12px;'>Al Guardar O Editar Este Formulario Sera Visible Solo En Su Cuenta.</b></div>");
							...
							//Elementos::CrearBoton("GuardarFormulario();","12","Guardar / Editar Formulario En Mi Cuenta","");//white-space: unset;
